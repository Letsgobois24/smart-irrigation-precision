<div class="flex flex-col gap-4 md:flex-row md:justify-between md:items-center mb-4">
    ...
    <!-- 🌿 Title -->
    <h1 class="text-2xl md:text-3xl font-bold text-green-800 flex items-center gap-2">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-4">
        ...
        <div wire:ignore x-data="clock(@js($now))" x-init="init()"
            class="font-mono text-sm md:text-base flex gap-2">
            <span x-text="time"></span>
            <span x-text="date" class="text-gray-500"></span>
        </div>
